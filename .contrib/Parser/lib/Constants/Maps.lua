...
ISLE_OF_QUELDANAS_MID_i = 2432;
SILVERMOON_CITY_MID = 2393;
EVERSONG_WOODS_MID = 2395;
HARANDAR = 2413;
VOIDSTORM = 2405;
ZULAMAN_MID = 2437;
--ISLE_OF_FANGS = XXXX;	-- Alex: probably won't be up until 0.5/0.7/1.0, on right side of Zul'Aman map.

ARCANTINA = 2541;

ATAL_AMAN = 16556;
COLLEGIATE_CALAMITY = 2547;
PARHELION_PLAZA = 16542;
SHADOWGUARD_POINT = 1111;
SUNKILLER_SANCTUM = 16592;
THE_DARKWAY = 2525;
THE_GULF_OF_MEMORY = 2505;
THE_GRUDGE_PIT = 2510;
THE_SHADOW_ENCLAVE = 2502;
TORMENTS_RISE = 16596;
TWILIGHT_CRYPTS = 16557;
