...
RAID_FLEXIBLE_VENDOR = createHeader({
	...
	text = {
		en = "Flexible Vendor",
		-- TODO: de = "",
		es = "Vendedor de bandas flexibles",
		mx = "Vendedor de bandas flexibles",
		-- TODO: fr = "",
		-- TODO: it = "",
		-- TODO: ko = "",
		-- TODO: pt = "",
...
RAID_NORMAL_VENDOR = createHeader({
	...
	text = {
		...
		es = "Vendedor de banda normal",
		mx = "Vendedor de banda normal",
...
RAID_HEROIC_VENDOR = createHeader({
	...
	text = {
		...
		es = "Vendedor de banda heroica",
		mx = "Vendedor de banda heroica",
...
RAID_MYTHIC_VENDOR = createHeader({
	...
	text = {
		...
		es = "Vendedor de banda mítica",
		mx = "Vendedor de banda mítica",
