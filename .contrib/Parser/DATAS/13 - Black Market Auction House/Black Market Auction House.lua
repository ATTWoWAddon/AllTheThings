...
BLACK_MARKET_AUCTION_HOUSE = createHeader({
	...
	description = {
		...
		-- TODO: de = "",
		es = "En lugar de comprar objetos a otros jugadores como en la Casa de Subastas normal, los objetos en el Mercado Negro son generados y listados por PNJ. Los objetos se listan solo por un día. Los artículos a la venta varían desde artículos que se volvieron inalcanzables, hasta botines raros y objetos del TCG. Todos los objetos se listan con poca frecuencia, por lo que no debe considerarse una forma confiable de obtener rarezas.\n\n Las pujas por monturas comienzan en 20,000 o, con algunas excepciones.\n Las pujas por compañeros comienzan entre 1 o y 20,000 o, dependiendo de la fuente original y lo difícil que sea obtenerlos.\n Los objetos de vanidad/varios comienzan entre 10,000 o y 15,000 o.\n\nLas pujas funcionan como en la Casa de Subastas normal. No hay precio de compra directa. El cielo (o el límite de oro) es el límite cuando compites con otros jugadores por la puja final. Con una compra exitosa, el objeto se envía por correo.\n\nLa disponibilidad de objetos depende del reino. Cada reino tendrá diferentes objetos a la venta en cualquier momento y es probable que los precios varíen enormemente de un servidor a otro.\n\nSi está vacía, la ventana de objetos mostrará \"No hay objetos disponibles en este momento. Vuelve a intentarlo más tarde.\"",
...
assignRootCategoryHeader(80, ROOTS.BlackMarket, BLACK_MARKET_AUCTION_HOUSE);
root(ROOTS.BlackMarket, bubbleDown({ ["timeline"] = { ADDED_5_0_4 }, ["u"] = BLACK_MARKET }, {
	...
	n(VENDORS, bubbleDown({
		...
		n(243247, {	-- Madam Goya [Silvermoon City]
			["coord"] = { 51.84, 48.53, MAP.MIDNIGHT.SILVERMOON_CITY },
		}),
		n(219055, {	-- Madam Goya [Dornogal]
			["coord"] = { 64.8, 52.7, DORNOGAL },
		}),
