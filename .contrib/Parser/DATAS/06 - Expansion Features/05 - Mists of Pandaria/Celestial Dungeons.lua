...
local clusters = function(cost, item)
	return applycost(item, { "c", AUGUST_STONE_CLUSTER, cost });
end
	...
	n(CELESTIAL_DUNGEON_DIFFICULTY, bubbleDownSelf({ ["timeline"] = { ADDED_5_5_0 } }, {
		...
		["groups"] = {
			...
			n(VENDORS, {
				...
				applyclassicphase(MOP_PHASE_SIEGE_OF_ORGRIMMAR_CELESTIAL_DUNGEONS, n(267317,	-- Celestial Harbinger <August Stone Cluster Exchange>
					bubbleDownSelf({ ["timeline"] = { ADDED_5_5_4 } }, {
					["aqd"] = {
						["coord"] = { 49.4, 75.2, SHRINE_OF_SEVEN_STARS_THE_IMPERIAL_EXCHANGE },
						["maps"] = { SHRINE_OF_SEVEN_STARS, SHRINE_OF_SEVEN_STARS_THE_IMPERIAL_EXCHANGE },
					},
					["hqd"] = {
						["coord"] = { 43.8, 42.4, SHRINE_OF_TWO_MOONS_THE_IMPERIAL_MERCANTILE },
						["maps"] = { SHRINE_OF_TWO_MOONS, SHRINE_OF_TWO_MOONS_THE_IMPERIAL_MERCANTILE },
					},
					["groups"] = appendGroups(
					{	-- Tier Tokens
						clusters(60, i(CELESTIAL_TOKENS.SEASON3.CONQUEROR.HELM)),
						clusters(50, i(CELESTIAL_TOKENS.SEASON3.CONQUEROR.SHOULDERS)),
						clusters(55, i(CELESTIAL_TOKENS.SEASON3.CONQUEROR.CHEST)),
						clusters(45, i(CELESTIAL_TOKENS.SEASON3.CONQUEROR.GAUNTLETS)),
						clusters(55, i(CELESTIAL_TOKENS.SEASON3.CONQUEROR.LEGS)),

						clusters(60, i(CELESTIAL_TOKENS.SEASON3.PROTECTOR.HELM)),
						clusters(50, i(CELESTIAL_TOKENS.SEASON3.PROTECTOR.SHOULDERS)),
						clusters(55, i(CELESTIAL_TOKENS.SEASON3.PROTECTOR.CHEST)),
						clusters(45, i(CELESTIAL_TOKENS.SEASON3.PROTECTOR.GAUNTLETS)),
						clusters(55, i(CELESTIAL_TOKENS.SEASON3.PROTECTOR.LEGS)),

						clusters(60, i(CELESTIAL_TOKENS.SEASON3.VANQUISHER.HELM)),
						clusters(50, i(CELESTIAL_TOKENS.SEASON3.VANQUISHER.SHOULDERS)),
						clusters(55, i(CELESTIAL_TOKENS.SEASON3.VANQUISHER.CHEST)),
						clusters(45, i(CELESTIAL_TOKENS.SEASON3.VANQUISHER.GAUNTLETS)),
						clusters(55, i(CELESTIAL_TOKENS.SEASON3.VANQUISHER.LEGS)),
					},
					{	-- Weapons
						-- One-Handed
					...
					{	-- Quest Items
						clusters(35, i(94867)),	-- Heart of the Thunder King
						clusters(5, i(94593)),	-- Secrets of the Empire
						clusters(15, i(94594)),	-- Titan Runestone
						clusters(15, i(87208)),	-- Sigil of Power
						clusters(15, i(87209)),	-- Sigil of Wisdom
					},
					{	-- Currency Conversion
						clusters(1, currency(AUGUST_STONE_SHARD)),	-- 2x Shards for 1 Cluster
						clusters(2, i(247796, {	-- Commendation of Service
							currency(395),	-- Justice Points
						})),
					}),
				}))),
