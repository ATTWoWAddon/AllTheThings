					...
					["groups"] = {
						...
						filter(BATTLE_PETS, {
							i(200173, {	-- Ghostflame (PET!)
								["cost"] = { { "c", ELEMENTAL_OVERFLOW, 1000 } },
							}),
