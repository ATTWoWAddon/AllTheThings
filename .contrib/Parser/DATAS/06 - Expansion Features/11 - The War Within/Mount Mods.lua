...
root(ROOTS.ExpansionFeatures, expansion(EXPANSION.TWW, bubbleDownSelf({ ["timeline"] = { ADDED_11_0_2 } }, {
	header(HEADERS.Item, 219391, {	-- Delver's Dirigible
		i(235697, {["timeline"] = { ADDED_11_2_0 } }),	-- Delver's Dirigible Schematic: Alliance Decal (MM!)
		i(238839, {["timeline"] = { ADDED_11_1_5 } }),	-- Delver's Dirigible Schematic: Arathi Decal (MM!)
		i(235694, {["timeline"] = { ADDED_11_2_0 } }),	-- Delver's Dirigible Schematic: Blue Paint (MM!)
		...
		i(235698, {["timeline"] = { ADDED_11_2_0 } }),	-- Delver's Dirigible Schematic: Horde Decal (MM!)
		...
		i(235695, {["timeline"] = { ADDED_11_2_0 } }),	-- Delver's Dirigible Schematic: Red Paint (MM!)
	...
	header(HEADERS.Item, 229974, bubbleDownSelf({ ["timeline"] = { ADDED_11_1_0 } }, {	-- Delver's Gob-Trotter
	...
	header(HEADERS.Item, 238051, bubbleDownSelf({ ["timeline"] = { ADDED_11_2_0 } }, {	-- Delver's Mana-Skimmer
