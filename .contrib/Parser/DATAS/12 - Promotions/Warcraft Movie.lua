...
WARCRAFT_MOVIE = createHeader({
	...
	description = {
		...
		-- TODO: pt = "",
		-- TODO: ru = "",
		cn = "这些是在《魔兽》电影仍在上映期间，每个阵营至少登入一次所获得的奖励。",
...
root(ROOTS.Promotions, n(WARCRAFT_MOVIE, bubbleDown({ ["u"] = REMOVED_FROM_GAME }, {
	...
	["groups"] = {
		...
		a(i(140997, {	-- Alliance Strongbox
			i(140999),	-- Replica Lion's Gang (COSMETIC!)
			i(141000),	-- Replica Lion's Heart (COSMETIC!)
		})),
		h(i(140998, {	-- Horde Strongbox
			i(141001),	-- Replica Blood Guard's Cleaver (COSMETIC!)
			i(141002),	-- Replica Staff of Gul'dan (COSMETIC!)
		})),
	},
})));
