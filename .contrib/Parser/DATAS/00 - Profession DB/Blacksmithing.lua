...
------------------
--- TRAINER ---
i(0, 1261982);		-- Aspirant's Meditation Pool
i(0, 1261980);		-- Bejeweled Venthyr Chalice
...
i(0, 1261234);		-- Pandaren Fireplace
i(0, 1261235);		-- Pandaren Signal Brazier
i(0, 1259675);		-- Rusting Bolted Bench
i(0, 1261497);		-- Shadowforge Sconce
i(0, 1259681);		-- Shredderwheel Storage Chest
i(0, 1262308);		-- Standing Smoke Lamp
i(0, 1261499);		-- Steel Ironforge Emblem
i(0, 1260692);		-- Stormsong Stove
i(0, 1260693);		-- Suramar Fence
i(0, 1260695);		-- Suramar Fencepost
i(0, 1260698);		-- Tauren Soup Pot
i(0, 1261892);		-- Valdrakken Hanging Cauldron
i(0, 1261896);		-- Wingrest Signal Brazier
--- ITEM ---
